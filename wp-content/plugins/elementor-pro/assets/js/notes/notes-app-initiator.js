...
(function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return Promise.all(/*! import() | notes-app */[__webpack_require__.e("vendors-node_modules_babel_runtime-corejs2_core-js_object_entries_js-node_modules_babel_runti-ff5d5b"), __webpack_require__.e("notes-app")]).then(__webpack_require__.bind(__webpack_require__, /*! ./app/app */ "../assets/js/app/app.js"));
  ...
  window.addEventListener('message', function (event) {
    ...
    var _window$top$$e$compon = window.top.$e.components.get('notes'),
        config = _window$top$$e$compon.config,
        userCanCreateThread = config.current_user_can.create,
        classNames = ['e-route-notes'];

    if (userCanCreateThread) {
      classNames.push('e-route-notes--notable');
    }

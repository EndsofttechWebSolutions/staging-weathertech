...
abstract class Base_Notes_Notification extends Notification {
	 ...
	 *
	 * @param \ElementorPro\Core\Notifications\Traits\Notifiable $notifiable
	 *
	 * @return array
	 */
	...
	/**
	 * Get the note date, formatted using the site preferences.
	 *
	 * @return string
	 */
	protected function get_date() {
		...
		return $this->note->updated_at->format( $format );
	}
